...
func (c *areaPolygonClient) CreateAreaPolygon(ctx context.Context, in *CreateAreaPolygonRequest, opts ...grpc.CallOption) (*CreateAreaPolygonReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.manage.v1.AreaPolygon/CreateAreaPolygon", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *areaPolygonClient) UpdateAreaPolygon(ctx context.Context, in *UpdateAreaPolygonRequest, opts ...grpc.CallOption) (*UpdateAreaPolygonReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.manage.v1.AreaPolygon/UpdateAreaPolygon", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *areaPolygonClient) DeleteAreaPolygon(ctx context.Context, in *DeleteAreaPolygonRequest, opts ...grpc.CallOption) (*DeleteAreaPolygonReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.manage.v1.AreaPolygon/DeleteAreaPolygon", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *areaPolygonClient) GetAreaPolygon(ctx context.Context, in *GetAreaPolygonRequest, opts ...grpc.CallOption) (*GetAreaPolygonReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.manage.v1.AreaPolygon/GetAreaPolygon", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *areaPolygonClient) ListAreaPolygon(ctx context.Context, in *ListAreaPolygonRequest, opts ...grpc.CallOption) (*ListAreaPolygonReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.manage.v1.AreaPolygon/ListAreaPolygon", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AreaPolygon_CreateAreaPolygon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.manage.v1.AreaPolygon/CreateAreaPolygon",
	}
...
func _AreaPolygon_UpdateAreaPolygon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.manage.v1.AreaPolygon/UpdateAreaPolygon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AreaPolygon_DeleteAreaPolygon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.manage.v1.AreaPolygon/DeleteAreaPolygon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AreaPolygon_GetAreaPolygon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.manage.v1.AreaPolygon/GetAreaPolygon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AreaPolygon_ListAreaPolygon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.manage.v1.AreaPolygon/ListAreaPolygon",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AreaPolygon_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.manage.v1.AreaPolygon",
	...
	Metadata: "api/manage/v1/area_polygon.proto",
}
