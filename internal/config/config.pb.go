...
type Config struct {
	...
	App    *app.Config   `protobuf:"bytes,5,opt,name=app,proto3" json:"app,omitempty"`
...
var file_internal_config_config_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x15, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x2f, 0x64, 0x62, 0x2f,
	0x64, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6e,
	...
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x12, 0x27, 0x0a, 0x03, 0x61, 0x70, 0x70, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x2e, 0x61,
	0x70, 0x70, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03, 0x61, 0x70, 0x70, 0x12, 0x29,
...
var file_internal_config_config_proto_goTypes = []interface{}{
	...
	(*log.Config)(nil),          // 5: component.log.Config
	(*redis.Config)(nil),        // 6: component.redis.Config
	(*db.Config)(nil),           // 7: component.db.Config
...
var file_internal_config_config_proto_depIdxs = []int32{
	...
	1, // 1: internal.config.Config.http:type_name -> internal.config.Http
	2, // 2: internal.config.Config.grpc:type_name -> internal.config.Grpc
	3, // 3: internal.config.Config.cron:type_name -> internal.config.Cron
	5, // 4: internal.config.Config.logger:type_name -> component.log.Config
	6, // 5: internal.config.Config.redis:type_name -> component.redis.Config
	7, // 6: internal.config.Config.db:type_name -> component.db.Config
	8, // 7: internal.config.Http.timeout:type_name -> google.protobuf.Duration
	8, // 8: internal.config.Grpc.timeout:type_name -> google.protobuf.Duration
